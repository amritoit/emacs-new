...
(custom-theme-set-faces
 ...
 '(default ((t (:inherit nil :stipple nil :background "##18392b" :foreground "#F8F8F8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 104 :width normal :foundry "outline" :family "Courier New"))))
 '(line-number ((t (:inherit (shadow default))))))

(provide-theme 'color-amrit)
